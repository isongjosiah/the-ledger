...
import { ITransactionDocument, TransactionModel } from "../models/userTransaction";

export class ITransactionRepository implements ITransactionRepository {
  async create(transaction: Transaction, session?: ClientSession): Promise<Transaction> {
  ...
  async update(transaction: Transaction, session?: ClientSession): Promise<Transaction> {
